...
import { Button, Form, Spinner, Modal, ListGroup } from "react-bootstrap";
...
const enviarMensaje = async () => {
    ...
    try {
        ...
        await addDoc(chatCollection, {
            text: `Ok vamos a registrar ${respuestaIA} en la base de datos.`,
            emisor: "ia",
            timestamp: new Date(),
        });
        ...
        try {
            ...
            if (datos.nombre && datos.descripcion) {
                ...
                await addDoc(chatCollection, {
                    text: `Categoria ${datos.nombre} registrada correctamente.`,
                    emisor: "ia",
                    timestamp: new Date(),
                });
            } else {
                await addDoc(chatCollection, {
                    text: "No se pudo registrar la categoria. El JSON no tiene informacion.",
                    emisor: "ia",
                    timestamp: new Date(),
                });
            }
            ...
            await addDoc(chatCollection, {
                text: "La IA no devolvio un JSON valido.",
                emisor: "ia",
                timestamp: new Date(),
            });
        }
        ...
        await addDoc(chatCollection, {
            text: "Ocurrio un error al enviar el mensaje. Por favor, intente nuevamente.",
            emisor: "ia",
            timestamp: new Date(),
        });
    } finally {
